...
export default {
    ...
    // ─── Login Screen ────────────────────────────────────────
    login: {
        subtitle: 'Create amazing stories',
        emailPlaceholder: 'Email address',
        passwordPlaceholder: 'Password',
        signIn: 'Sign In',
        googleSignIn: 'Sign In with Google',
        footer: 'Let your imagination soar',
        loginFailed: 'Login Failed',
        googleSignInTitle: 'Google Sign-In',
        googleSignInMessage:
            "Google sign-in doesn't work in Expo Go. Requires a development build.\n\nPlease use email/password for now.",
        errors: {
    ...
    create: {
        ...
        noCredits: {
            ...
            message:
                'Purchase premium or watch an ad to create more stories.',
    ...
    premium: {
        ...
        disclaimer: 'Subscription automatically renews unless cancelled.\nManage or cancel from your App Store settings.',
        termsOfUse: 'Terms of Use',
        privacyPolicy: 'Privacy Policy',
        parentalGate: {
        ...
        purchaseMessage: 'Your premium membership is active! ({{days}} days, {{stories}} stories)',
